...
import {
    ...
    Container,
    Stack,
    Box, ButtonGroup, Card, CardBody, CardHeader, Heading, StackDivider, Text, Table, TableContainer, Tbody, Td, Tfoot, Th, Thead, Tr, useToast
...
const booking = async (data) => {
    return await axios.post('https://nice-gold-crocodile-hat.cyclic.app/users/booking', data)
}
...
const SlotBooking = ({ car }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        data["total"] = total
        showToast("Car is Booked!Details Sent on email!", "success")
        booking(data).then((r) => {
            console.log(r)
            navigate('/thanking')
